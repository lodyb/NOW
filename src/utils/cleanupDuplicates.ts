...
import { MediaTag } from '../database/entities/MediaTag';
 ...
 */
export async function cleanupDuplicateMedia(): Promise<void> {
    ...
    for (const group of duplicateGroups) {
      ...
      for (const recordToRemove of recordsToRemove) {
        ...
        await AppDataSource.manager.transaction(async (transactionalEntityManager) => {
          ...
          await transactionalEntityManager.remove(recordToRemove);
        });
